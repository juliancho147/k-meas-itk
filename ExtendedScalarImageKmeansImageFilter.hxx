 ...
 *
 *=========================================================================*/
#ifndef itkExtendedScalarImageKmeansImageFilter_hxx
#define itkExtendedScalarImageKmeansImageFilter_hxx
...
ExtendedScalarImageKmeansImageFilter< TInputImage, TOutputImage >
...
template< typename TInputImage, typename TOutputImage >
void ExtendedScalarImageKmeansImageFilter< TInputImage, TOutputImage >
...
::GenerateData()
{
  ...
  if ( m_UseNonContiguousLabels )
    {
    labelInterval = ( itk::NumericTraits< OutputPixelType >::max() / numberOfClasses ) - 1;
    }
  ...
  if ( m_ImageRegionDefined )
    ...
    using ExclusionImageIteratorType = itk::ImageRegionExclusionIteratorWithIndex<OutputImageType>;
